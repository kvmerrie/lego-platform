...
function createSyncSummary(setIds: readonly string[]): CommerceSyncRunResult {
  return {
    ...
    currentOfferSnapshotBestOfferMismatchCount: 0,
    currentOfferSnapshotBestOfferMismatchSample: [],
    currentOfferSnapshotCount: 0,
    currentOfferSnapshotLiveSummaryCount: 0,
    currentOfferSnapshotLiveSummaryMissingSnapshotCount: 0,
    currentOfferSnapshotMissingBestOfferCount: 0,
    currentOfferSnapshotMissingBestOfferSample: [],
    currentOfferSnapshotMissingLiveSummaryCount: 0,
    ...
    currentOfferSnapshotOfferCount: 0,
    currentOfferSnapshotsUpsertedCount: 0,
    dailyHistoryPointCount: setIds.length,
    dailyHistorySummary: {
      dailyHistoryPointsBuilt: setIds.length,
      eligibleLatestOfferRows: setIds.length,
      latestOfferRowsSeen: setIds.length,
    ...
    dealPageSnapshotCount: 0,
    dealPageSnapshotsUpsertedCount: 0,
    enabledSetCount: setIds.length,
    merchantCount: 4,
    merchantPageSnapshotChangedMerchantCount: 0,
    merchantPageSnapshotCount: 0,
    merchantPageSnapshotSkipped: false,
    merchantPageSnapshotsUpsertedCount: 0,
    mode: 'write',
    phaseTimings: {},
    ...
    scopedMerchantSlugs: [],
    scopedSetIds: setIds,
    setDetailRelatedThemeSnapshotCount: 0,
    setDetailRelatedThemeSnapshotsUpsertedCount: 0,
  };
}
