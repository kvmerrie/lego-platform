...
describe('alternate affiliate feed server', () => {
  ...
  test('does not retire active seeded live offers from a non-authoritative feed absence', async () => {
    ...
    const result = await importAffiliateFeedRowsForMerchant({
      dependencies: {
        ...
        listCommerceOfferSeedsFn: vi.fn().mockResolvedValue([
          ...
          {
            id: 'seed-43300-alternate-manual',
            setId: '43300',
            merchantId: 'merchant-alternate',
            ...
            validationStatus: 'valid',
            lastVerifiedAt: '2026-05-08T18:01:37.786Z',
            notes: 'Manual seed from an older operator import.',
            createdAt: '2026-04-22T09:00:00.000Z',
            updatedAt: '2026-05-08T18:02:25.513Z',
            latestOffer: {
              id: 'latest-43300-alternate-manual',
              offerSeedId: 'seed-43300-alternate-manual',
              setId: '43300',
              merchantId: 'merchant-alternate',
              productUrl: 'not-a-url',
              fetchStatus: 'success',
    ...
    expect(result).toMatchObject({
      ...
      existingStaleSuccessLatestCount: 2,
      existingStaleSuccessLatestDuplicateSeedCount: 2,
      existingStaleSuccessLatestMissingFromFeedCount: 2,
      existingStaleSuccessLatestSample: [
        {
          ageBucket: '2_7_days',
          fetchedAt: '2026-05-08T18:01:37.786Z',
          likelyReason: 'duplicate_seed_same_set_merchant',
          likelyReasons: [
          ...
          productUrl:
            'https://www.alternate.nl/tt/?tt=904_1594453_508318_&r=https%3A%2F%2Fwww.alternate.nl%2FLEGO%2FDisney-Classic-Winnie-de-Poeh-Constructiespeelgoed%2Fhtml%2Fproduct%2F100151401',
          seedUrlHost: 'www.alternate.nl',
          setId: '43300',
        },
        {
          ageBucket: '2_7_days',
          fetchedAt: '2026-05-08T18:01:37.786Z',
          likelyReason: 'seed_url_missing_or_invalid',
          likelyReasons: [
