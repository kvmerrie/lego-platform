...
function createCurrentOfferSnapshotRow(
  ...
  return {
    ...
    best_checked_at: '2026-06-16T09:00:00.000Z',
    ...
    computed_at: '2026-06-16T10:00:00.000Z',
    condition: 'new',
    currency_code: 'EUR',
    offer_count: 1,
    offers: [
...
describe('catalog data access server', () => {
      ...
      latestOfferRows: [
        {
          ...
          currency_code: 'EUR',
          availability: 'in_stock',
          fetched_at: '2026-06-15T10:15:00.000Z',
          fetch_status: 'success',
          observed_at: '2026-06-15T09:30:00.000Z',
          updated_at: '2026-06-15T09:35:00.000Z',
        },
        {
          ...
          fetch_status: 'success',
          observed_at: '2026-06-15T08:30:00.000Z',
          updated_at: '2026-06-15T08:35:00.000Z',
        },
        {
          ...
          fetch_status: 'success',
          observed_at: '2026-06-15T10:30:00.000Z',
          updated_at: '2026-06-15T10:35:00.000Z',
        },
        {
          ...
          availability: 'in_stock',
          fetch_status: 'error',
          observed_at: '2026-06-15T11:30:00.000Z',
          updated_at: '2026-06-15T11:35:00.000Z',
        },
      ],
      merchantRows: [
        {
    ...
    expect(result).toEqual([
      {
        ...
        observedAt: '2026-06-15T09:30:00.000Z',
        priceSpreadMinor: 2000,
        recentReferencePriceChangeMinor: -1000,
        recentReferencePriceChangedAt: '2026-06-15',
    ...
    const { supabaseClient } = createCatalogOverlaySupabaseClient({
      latestOfferRows: [
        ...
        },
        {
          ...
          availability: 'in_stock',
          fetch_status: 'success',
          observed_at: '2026-06-15T09:31:00.000Z',
          updated_at: '2026-06-15T09:36:00.000Z',
        },
      ],
      merchantRows: [
        {
    ...
    const { supabaseClient } = createCatalogOverlaySupabaseClient({
      latestOfferRows: [
        ...
        },
        {
          ...
          availability: 'in_stock',
          fetch_status: 'success',
          observed_at: '2026-06-15T07:30:00.000Z',
    ...
    expect(result).toEqual([
      {
        ...
        offers: [
          ...
          },
          {
            ...
            checkedAt: '2026-06-15T08:30:00.000Z',
            condition: 'new',
            commercialUnitType: 'full_set',
            currency: 'EUR',
            market: 'NL',
      ...
      },
      {
        bestOffer: {
          availability: 'in_stock',
          checkedAt: '2026-06-15T07:30:00.000Z',
          condition: 'new',
          commercialUnitType: 'full_set',
          currency: 'EUR',
          market: 'NL',
      ...
      latestOfferRows: [
        {
          ...
          currency_code: 'EUR',
          availability: 'in_stock',
          fetched_at: '2026-06-15T10:00:00.000Z',
          fetch_status: 'success',
          observed_at: '2026-06-15T09:55:00.000Z',
  ...
  test('lists suggested missing sets with retail-weighted ranking and excludes weak themes', async () => {
    ...
    const results = await listCatalogSuggestedMissingSets({
      fetchImpl,
      limit: 3,
      nowImpl: () => new Date('2026-06-15T08:00:00.000Z').getTime(),
      supabaseClient,
    });
  ...
  test('upserts generic catalog set source metadata by set, source and locale', async () => {
    ...
    const result = await upsertCatalogSetSourceMetadata({
      inputs: [
        {
          catalogSetId: '10316',
          lastSeenAt: '2026-06-15T17:30:00.000Z',
          locale: 'nl-NL',
      ...
      [
        {
          ...
          last_seen_at: '2026-06-15T17:30:00.000Z',
          locale: 'nl-NL',
          match_confidence: 'exact_set_number',
          metadata_json: {
            description: 'Bouw Rivendell.',
