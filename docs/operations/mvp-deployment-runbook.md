...
- use `docs/operations/catalog-promotion.md` for the staging-first catalog promote flow, ownership rules, and parity diagnostics
- use `docs/operations/production-lifecycle-verification.md` for the full operational lifecycle checklist after promote/deploy/commerce changes
